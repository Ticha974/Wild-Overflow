...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
     ...
     * @return \Doctrine\ORM\EntityRepository|\Doctrine\Persistence\ObjectRepository|UserInterface|null
     */
    ...
    public function getUser($credentials, UserProviderInterface $userProvider) # SECOND
    {
        ...
        if (!$user) {
            throw new UserNotFoundException(sprintf('User "%s" not found', $credentials['email']));
        }
